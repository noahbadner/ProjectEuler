...
# Problem 17
#
# If the numbers 1 to 5 are written out in words; one, two, three, four, five, then there are 3 + 3 + 5 + 4 + 4 = 10
# letters used in total.
#
# If all the numbers from 1 to 1000 (one thousand) inclusive were written out in words, how many letters would be used?
#
# NOTE: Do not count spares or hyphens. For example, 342 (three hundred and forty-two) contains 23 letters and 115
...
def int_to_written_number(n):
    """Returns the representation of a given number written as natural language in compliance with British English"""
    # Thousands
    if n >= 1000:
...
def main():
    ...
    solution = letters_in_string(words_string)
    print(solution)
