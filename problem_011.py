...
#   [figure included in resource file]
#
...
RESOURCE_FILE_PATH_011 = "resources/problem_011_grid.txt"
...
def grid_greatest_adjacent_product(n, array_2d):
    """Return the greatest product of n adjacent numbers at any indices in a given grid"""
...
def main():
    """Main method"""
    grid = parse_file(RESOURCE_FILE_PATH_011)

    solution = grid_greatest_adjacent_product(4, grid)
    print(solution)
